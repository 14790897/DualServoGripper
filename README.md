...
### 🌐 访问方式
- **IP地址**: `http://192.168.1.xxx` (设备显示的IP)
- **域名**: `http://dualservogripper.local` (推荐使用)
...
- 确认设备已连接WiFi
- 检查串口输出获取正确IP地址
- 尝试使用域名访问: `http://dualservogripper.local`
- 确认防火墙设置
- 对于mDNS问题，可能需要安装Bonjour服务(Windows)

### 4. mDNS域名无法访问

- Windows用户可能需要安装Apple Bonjour服务
- 确认设备和电脑在同一网络中
- 尝试使用IP地址直接访问
- 检查路由器是否支持组播
